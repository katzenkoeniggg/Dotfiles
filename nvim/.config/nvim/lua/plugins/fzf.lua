return {
   ...
   keys = {
      ...
      { "<leader>fgd", "<cmd>FzfLua lsp_definitions<cr>", desc = "LSP definitions" },
      { "<leader>fgi", "<cmd>FzfLua lsp_implementations<cr>", desc = "LSP implementations" },
      { "<leader>fgt", "<cmd>FzfLua lsp_typedefs<cr>", desc = "LSP type definitions" },
